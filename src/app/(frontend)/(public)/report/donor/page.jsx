...
import {
    getDonor,
    getInActiveDonor, updateDonorStatus,
            ...
            <div>
                <div className="mx-10">
                        ...
                        title2={
                            <div className="flex flex-col  ">
                                <div className=" flex justify-end gap-3">
                                    ...
                                    <button
                                        className={` ${
                                            active ? "bg-green-500 rounded-md px-3 py-2 shadow-md text-white" : "bg-indigo-600 rounded-md px-3 py-2 shadow-md text-white"
                                        }`}
                                        onClick={() => {
                                            setActive(true);
                                            setInactive(false);
                                    ...
                                    <button
                                        className={` ${
                                            inActive ? "bg-green-500 rounded-md px-3 py-2 shadow-md text-white" : "bg-indigo-600 rounded-md px-3 py-2 shadow-md text-white"
                                        }`}
                                        onClick={() => {
                                            setActive(false);
                                            setInactive(true);
                    ...
                    <input type="checkbox" name="" id="" />
                                        ...
                                        {(active ? donorList : inActiveDonorList)?.map((item, index) => {
                                            return (
                                                <tr
