      ...
      {openModel ? (
        <Modal>
          <div className="bg-white min-w-[50vw] rounded-md px-10 py-6">
            ...
            <form
              action=""
              onSubmit={handleSubmit((data) => handleDiscard(data))}
            >
              <div>
              ...
              <div className="flex justify-end gap-6 text-white my-4">
                <button
                  className={
                    "bg-gray-300 rounded-md px-6 py-2 hover:bg-gray-400"
                  }
                  type={"button"}
                ...
                <button
                  className={
                    "bg-red-600 rounded-md px-6 py-2 hover:bg-red-700 disabled:bg-gray-300 disabled:cursor-not-allowed"
                  }
                  type={"submit"}
                ...
                {bottles?.bottleList?.map((bottle, index) => {
                  return (
                    <div
                      key={index}
                      className={` ${
                        bottle?.remainingVoluem == 0 ? "bg-red-300" : ""
                      } ${
                        bottle?.isActive === false
                          ? "bg-red-600 text-white "
                          : ""
                      }  flex items-center gap-3  bg-gray-200 px-3 py-2  rounded-md`}
                    >
                      <div className={""}>
                        <p>
                          Batch Id:
                      ...
                      <div>
                        {bottle.isActive && (
                          <button
                            onClick={() =>
                              discardModelHandler(bottle?._id, bottle?.isActive)
                            }
                            className={
                              "bg-indigo-600 text-white px-3 py-2 rounded-md "
                            }
                            type={"button"}
                          >
                            {" "}
                            {bottle?.isActive ? "Discard" : "Reactive "}
                          </button>
                        )}
                      </div>
                    </div>
